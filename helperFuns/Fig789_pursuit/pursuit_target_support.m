...
if exist(target_mat_filename, 'file')
    ...
    for t_indx = 1:time_horizon
        ...
        relv_indx = target_sys.state_dim *(t_indx-1) + target_relv_states;
    ...
    % Add the t=0 case
    target_support_timer = tic;
    target_support_position = [Polyhedron('V', ...
                                    target_init_state(target_relv_states)'), ...
        target_support_position];
    elapsed_time_target_support(1) = toc(target_support_timer);
    
    save(strcat('./helperFuns/Fig789_pursuit/',target_mat_filename), ...
