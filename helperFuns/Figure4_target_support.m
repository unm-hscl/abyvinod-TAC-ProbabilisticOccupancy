...
if exist(target_mat_filename, 'file')
    ...
    target_support_position = [Polyhedron(2)];
    ...
    target_support_position = [Polyhedron(2), target_support_position];

    save(strcat('./helperFuns/',target_mat_filename),'target_support_position');
