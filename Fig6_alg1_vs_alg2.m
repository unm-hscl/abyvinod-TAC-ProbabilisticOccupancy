...
timer=tic;
[xvec,yvec,frequency,other_values] = ...
...
colormap('hot')
contour(xvec(1:10:end),yvec(1:10:end),frequency(1:10:end,1:10:end),[alpha_value alpha_value], 'LineColor',[0.9290 0.6940 0.1250], 'LineWidth',2);
...
disp(' MC    | Alg. 1| Alg. 2');
fprintf('%2.3f | %2.3f | %2.3f\n', elapsed_time_MC, elapsed_time_polytope, elapsed_time_minksum);
